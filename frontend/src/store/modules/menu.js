import MenuClient from "../../data/menuClient.json";
import MenuAdmin from "../../data/menuAdmin.json";
import MenuUploader from "../../data/menuUploader.json";

const state = {
  dataClient: MenuClient.data,
  dataAdmin: MenuAdmin.data,
  dataUploader: MenuUploader.data,
  searchData: [],
  togglesidebar: true
};
